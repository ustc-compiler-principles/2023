...
C++ 是一门面向对象的语言，在 C 语言之上添加了许多新特性。我们的实验实验并不需要你们使用所有高级的 C++ 特性，在此简单介绍一下部分特性便于理解。如果对 C++ 有更深的兴趣，可以从 Milo Yip 的[游戏程序员的学习之路](https://github.com/miloyip/game-programmer/blob/master/game-programmer-zh-cn.jpg?raw=true)的 C++ 部分开始看。
